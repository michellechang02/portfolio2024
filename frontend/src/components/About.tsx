...
const About: React.FC = () => {
    ...
    const list: ListItem[] = [
        ...
        { title: "A Day at Changkyung-goong (창경궁)", img: "tradition.jpg" },
        { title: "Spring Break Trip to Puerto Rico", img: "puerto.JPG" },
        { title: "Makeup that survived the snorkeling", img: "ship.jpg" },
        { title: "OurCS at Carnegie Mellon SCS", img: "cmu.jpg" },
        { title: "Outdoor day with JEM (Joyce Emily Michelle)", img: "jem.jpg" },
        { title: "Christmas in The Hyundai, South Korea", img: "christ.jpg" }
    ];
    ...
    return (
        !clicked ? (
                ...
                <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", height: "100vh", alignItems: "center" }}>
                    ...
                    <div className="flex flex-col justify-center items-center w-full px-20" style={{ marginBottom: '200px' }}>
                        <div className="flex justify-center items-center w-full">
                            <Button isIconOnly color="primary" aria-label="LinkedIn" className="mx-5" size="lg" variant="ghost"
                                onPress={() => window.location.href = 'https://www.linkedin.com/in/michellechang02/'}>
                                <Linkedin />
                            </Button>
                            <Button isIconOnly color="default" aria-label="GitHub" className="mx-5" size="lg" variant="ghost"
                                onPress={() => window.location.href = 'https://github.com/michellechang02/'}>
                                <GitHub />
                            </Button>
                            <Button isIconOnly color="secondary" aria-label="Email" className="mx-5" size="lg" variant="ghost"
                                onPress={() => window.location.href = 'mailto:michelleminjichang@gmail.com'}>
                                <Mail />
                            </Button>
                        </div>
                        <div className="flex justify-center items-center w-full mt-10">
                            <Button color="default" variant="light" onPress={() => setClicked(true)}>
                                <ArrowDownCircle />
                            </Button>
                        </div>
                    </div>
            ...
            <div style={{ position: "relative", display: "grid", placeItems: "center", height: "100vh", padding: "20px" }}>
                <Button color="default" variant="light" onPress={() => setClicked(false)} className="mt-4 mb-4">
                    <ArrowUpCircle />
                </Button>
